...
class PromptRouter:
    ...
    def __init__(self):
        ...
        self.intent_keywords = {
            'grok': ['ui', 'interface', 'design', 'reasoning', 'logic', 'analyze', 'visualization'],
            'claude': ['write', 'essay', 'article', 'content', 'creative', 'story', 'summarize'],
            'gpt4o': ['code', 'program', 'develop', 'implement', 'script', 'function', 'algorithm'],
            'manus': ['infra', 'infrastructure', 'system', 'architecture', 'deploy', 'setup', 'configure']
        }
